            ...
            let proofs = self
                ...
                .map_err(|e| {
                    ...
                    Error::InternalError(format!(
                        "Unable to retrieve epoch change proof from storage for \
                         Waypoint. The node will continue to sync, but the validator \
                         will not be able to sign transactions. State for \
